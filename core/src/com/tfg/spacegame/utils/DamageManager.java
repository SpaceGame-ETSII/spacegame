...
public class DamageManager {
    ...
    public static void load(){
        ...
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Basic.class,Yellow.class),4);
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Basic.class,Red.class),2);
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Basic.class,Blue.class),3);
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Basic.class,Orange.class),20);
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Basic.class,Purple.class),3);
        ...
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Yellow.class,Yellow.class),3);

        // Arma verde con los enemigos a los que daña
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Green.class,Yellow.class),3);
        ...
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Green.class,Green.class),1);
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Green.class,Blue.class),1);

        // Arma verde (su fuego) con los enemigos a los que daña
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(GreenFire.class,Yellow.class),3);
        ...
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(GreenFire.class,Green.class),1);
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(GreenFire.class,Blue.class),1);

        // Arma roja con los enemigos a los que daña
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Red.class,Red.class),5);
        ...
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Red.class,Purple.class),10);
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Red.class,Orange.class),15);

        // Arma azul con los enemigos a los que daña
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Blue.class,Blue.class),30);
        ...
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Blue.class,Purple.class),5);
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Blue.class,Green.class),30);

        // Arma morada con los enemigos a los que daña
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Purple.class,Purple.class),20);
        ...
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Purple.class,Red.class),2);
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Purple.class,Blue.class),15);

        // Arma naranja con los enemigos a los que daña
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Orange.class,Orange.class),10);
        ...
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Orange.class,Yellow.class),1);
        damageByTypeOfShootAndEnemy.put(new Pair<Class, Class>(Orange.class,Red.class),1);
    }
