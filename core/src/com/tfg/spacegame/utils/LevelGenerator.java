...
public class LevelGenerator {
     ...
     */
    public Array<Enemy> update(Array<Enemy> enemies,float delta, CampaignShip target){
    ...
    private void addEnemy(Array<Enemy> enemies, EnemyWrapper wrapper, CampaignShip target) {
        switch (wrapper.type){
            case TYPE1:
